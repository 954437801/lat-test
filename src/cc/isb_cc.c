 ...
 *
 * 用例来源 = 实测 三层映射 round5_form_weights.csv 的实测 k90 形态, 共 44 条
 ...
 *     setp/seto/setno/cmovnp 在表里 nf=0 且计划也未点名 -> 本次不登记。
 ...
 *
 * 本组实测结论(四重证据齐): 44 条 kat_st=OK 8/8(四形态零告警)
 * + kat_audit.py 审=44 通过=44 + 负向注入 9 处全检出 + x86_64 参考机
